...
def training(args):
    ...
    # make json file to coco dataset format
    ...
    cfg = get_cfg()
    cfg.merge_from_file(model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml")) # load mask rcnn structure
    ...
    cfg.SOLVER.IMS_PER_BATCH = args.mask_batch      # batch size
    ...
    cfg.SOLVER.MAX_ITER = args.mask_iters           # iterations
    cfg.SOLVER.STEPS = [5000, 10000, 15000]         # lr scheduler steps
