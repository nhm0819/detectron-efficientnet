...
parser.add_argument('--dataset_size', type=int, default=100000, metavar='N',
...
def train_all(args):
    ...
    if not args.testing:
        if (round(args.AP, 3) + 0.2) > float(args.mask_path.split("_")[-1][:-3]): # 'args.AP' is made in 'mask_train.py'
